if (!customElements.get('quick-add-modal')) {
  customElements.define(
    ...
    class QuickAddModal extends ModalDialog {
      ...
      show(opener) {
        const modalType = opener.tagName === 'QUICK-VIEW-BUTTON' ? 'quick-view' : 'quick-add';
        ...
        fetch(opener.dataset.productUrl)
          ...
          .then((responseText) => {
            ...
            if (modalType === 'quick-view') {
              console.log('Quick View modal triggered');
              this.modalContent.classList.add('quick-view-mode');
            }
